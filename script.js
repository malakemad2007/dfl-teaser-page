...
const faqData = [
  {
    ...
    answer:
      "Think of it as the older sibling many of us wish we had. We're building a place where students can discover opportunities, learn how to apply for them, and realize that people like us can do incredible things too.",
  },
  {
    question: "Who is this for?",
    answer:
      "If you're a student who has ever Googled: 'Fully funded summer programs for international students', 'How do people get into Harvard?', 'I have no extracurriculars. Am I cooked?' Congratulations. You're one of us.",
  },
  {
    question: "Is this really free?",
    answer:
      "Yep. Actually free. No hidden fees. No 'pay to unlock the good stuff.' No suspicious motivational guru energy.",
  },
  {
    question: "I feel lost. Where do I even start?",
    answer:
      "Same. That's exactly why Dear Future Luminary exists. Start anywhere—the opportunities, the guides, the roadmaps. Nobody has life figured out at 17. Or 18. Or, honestly, ever.",
  },
  {
    question: "I'm not extraordinary enough for these opportunities.",
    answer:
      "Respectfully... says who? Most students you admire started with zero awards, zero connections, and a lot of self-doubt. The difference is that they applied anyway. Please don't reject yourself before the application even can.",
  },
  {
    question: "There's too much information online. It's overwhelming.",
    answer:
      "We know. One person says, 'Build a startup.' Another says, 'Publish research.' A third tells you to wake up at 5 AM and meditate on a mountain. We're trying to make things simpler.",
  },
  {
    question: "Can I trust these opportunities?",
    answer:
      "If it's on Dear Future Luminary, we've done our homework. We care way too much about students to send them somewhere sketchy.",
  },
  {
    question: "Can I suggest opportunities or resources?",
    answer:
      "Please do. This isn't supposed to be a one-person mission. If you've found something amazing, we'd love to hear about it.",
  },
  {
    question: "Can I work with Dear Future Luminary?",
    answer:
      "Absolutely. If you enjoy helping people, creating cool things, and occasionally questioning your life choices while fixing a website bug at midnight, you'll fit right in.",
  },
  {
    question: "Who's behind all this?",
    answer:
      "A student. Not a giant organization. Not a company with a fancy office and unlimited coffee. Just someone who got tired of watching talented students miss opportunities because nobody told them where to look.",
  },
  {
    question: "What does 'Luminary' mean here?",
    answer:
      "Someone who shines—and helps others shine too. Cheesy? Maybe. True? Also yes.",
  },
  {
    question: "Still wondering something?",
    answer:
      "Ask us. Worst case scenario, we answer with an unnecessarily long paragraph because we got excited.",
  },
];
...
const programsData = [
  { name: "Scholar", logo: "client/public/images/logos/afs.png" },
  {
    ...
    logo: "client/public/images/kode with klossy.png",
  },
  {
    name: "Scholar",
    logo: "client/public/images/logos/stanford_code_in_place.png",
  },
  { name: "Reporter", logo: "client/public/images/logos/unicef.png" },
  { name: "Mentor", logo: "client/public/images/logos/soliya.png" },
  {
    name: "Pre-Finalist",
    logo: "client/public/images/logos/nasa_space_apps.png",
  },
  { name: "Youth Advocate", logo: "client/public/images/ioy-logo.svg" },
  {
    name: "Gold medalist '23",
    logo: "client/public/images/logos/climate_olympiad.png",
  },
  { name: "Ambassador", logo: "client/public/images/OIP.webp" },
  {
    name: "Girls Who Code",
    logo: "client/public/images/logos/girls_who_code.png",
  },
  {
    name: "Researcher",
    logo: "client/public/images/NYAS-Swirl-Featured-Image.png",
  },
...
function toggleFAQ(index) {
  ...
  const isOpen =
    container.style.maxHeight && container.style.maxHeight !== "0px";

  document.querySelectorAll(".faq-answer-wrapper").forEach((el, i) => {
    if (i !== index) {
      el.style.maxHeight = "0";
      el.parentElement.querySelector(".faq-arrow").style.transform =
        "rotate(0deg)";
    }
  });
...
const successMessages = [
  {
    title: "The Luminary signal has been received.",
    text: "Your message has been safely delivered. Time for us to pretend we're not ridiculously excited when people contact us.",
  },
  {
    title: "The Luminary signal has been received.",
    text: "Your message has been safely delivered. We're trying to act cool about it.",
  },
  {
    title: "The Luminary signal has been received.",
    text: "Your message made our day approximately 73% better.",
  },
  {
    title: "The Luminary signal has been received.",
    text: "Time for us to pretend we're not doing a little happy dance.",
  },
  {
    title: "The Luminary signal has been received.",
    text: "We're pretending to be professional, but we're ridiculously excited you reached out.",
  },
  {
    title: "The Luminary signal has been received.",
    text: "Your message is now hanging out in our inbox. We'll be with you soon.",
  },
];
...
function showSoonModal() {
  openModal("soon-modal");
}

function hideSoonModal() {
  closeModal("soon-modal");
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (cursor && window.matchMedia("(pointer: fine)").matches) {
    ...
    document
      .querySelectorAll(
        "a, button, input, textarea, .cursor-pointer, .faq-item-premium"
      )
      .forEach(el => {
